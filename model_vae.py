...
class Encoder(nn.Module):
    ...
    def __init__(self, dim_latent):
        ...
        self.conv1 = nn.Conv2d(n_channel, 8, kernel_size=3, stride=2, padding=1)  # input_channel can change
        self.conv2 = nn.Conv2d(8, 16, kernel_size=3, stride=2, padding=1)
        self.bn = nn.BatchNorm2d(16)
        self.conv3 = nn.Conv2d(16,32,kernel_size=3, stride=2, padding=0)

        self.linear1 = nn.Linear(3*3*32, 128)
        self.linear2 = nn.Linear(128, dim_latent)
        self.linear3 = nn.Linear(128, dim_latent)
